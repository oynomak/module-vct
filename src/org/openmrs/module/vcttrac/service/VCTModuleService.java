...
@Transactional
public interface VCTModuleService {
	
	/**
	 * This method attempts to find the client by checking first into vct_client object and in the
	 * second time into the patient_identifier object using of the OpenMRS API
	 * 
	 * @param nid National Identifier
	 * @return personId
	 */
	 ...
	 * Auto generated method comment
	 * 
	 * @param vctorpit 1 means that you want vct clients, 2 means that you want pit clients and 0
	 *            means that you want all
